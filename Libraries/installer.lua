return (function(ria)
	...
	if base64_decode == nil then
		local base64_decode = base64_decode or function decodeBase64(data)
	...
	if base64_encode == nil then
		local base64_encode = base64_encode or function encodeBase64(data)
    		local b = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'
    		return ((data:gsub('.', function(x) 
        	local r,b='',x:byte()
